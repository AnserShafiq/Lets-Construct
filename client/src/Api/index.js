...
// const url4 = 'http://localhost:5000/workers/usernames'; // Endpoint to fetch worker usernames
...
// export const fetchWorkerUsernames = () => axios.get(url4);
import axios from 'axios';
...
const url6 = 'http://localhost:5000/workers/login'; // Endpoint to fetch worker usernames
